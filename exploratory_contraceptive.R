    ...
    output$prevalence <- renderPlot(
        clean %>% 
            ...
            scale_fill_gradientn(name = "Prevalence (%)", 
                                 ...
                                 na.value = "white") +
            labs(title = "Most recent contraceptive prevalence around the world since 2000") + 
    ...
    output$modern <- renderPlot(
        clean %>% 
            ...
            scale_fill_gradientn(name = "Prevalence (%)", 
                                 ...
                                 na.value = "white") +
            labs(title = "Most recent proportion of modern contraceptives around the world since 2000") + 
            theme(panel.grid.major = element_blank(), 
                  panel.background = element_blank(),
                  axis.title = element_blank(), 
                  axis.text = element_blank(),
    ...
    output$proportion <- renderPlot(
        clean %>% 
            ...
            scale_fill_gradientn(name = "Prevalence", 
                                 ...
                                 na.value = "white") +
            labs(title = paste0("Most recent proportion of ", input$method, " contraceptive around the world since 2000")) + 
            theme(panel.grid.major = element_blank(), 
                  panel.background = element_blank(),
                  axis.title = element_blank(), 
                  axis.text = element_blank(),
