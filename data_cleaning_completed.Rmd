...
* Data description: GDP per capita(divided by midyear population), calculated in constant 2010 US dollars
=======
* Data source:[Data source]()
* Data description:
>>>>>>> 3298aa87674ede7d0116986c058bf94fb13f0241
...
* Data source: Gapminder
* Data description: average years in school for women of reproductive age 15 to 44, including primary, secondary and tertiary education. Since gapminder did not have a data for both sexes and our interest is reproductive health, we choose female gender group for this predictor
...
* Data source: Gapminder
* Data description: Estimated percentage of adults aged 15-49 years that are newly infected with HIV (incidence); Estimated percentage of adults aged 15-49 years that are infected by HIV (prevalence)
...
lm_syphilis <- lm(syphilis_rate ~ region_l + years_in_school + gdp +
                      score + any_method, data = data) #Create the linear regression
summary(lm_syphilis) 
