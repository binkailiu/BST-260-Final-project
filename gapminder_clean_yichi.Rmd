...
#gapminder_predictors <- left_join(gdp_latest, edu_latest, by = "country") 
...
head(infant_raw)
infant <- infant_raw %>% filter(IsLatestYear=="TRUE") %>% select(`Location`,`Period`, `FactValueNumeric`)
